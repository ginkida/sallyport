...
TOOLS: list[Tool] = [
    ...
    Tool(
        ...
        description=(
            ...
            "contentType, size, body?, bodyTruncated?, bodyOmitted?}], "
            "truncated?} (oldest→newest; type is 'xhr'|'fetch'; body is the "
            "response text, omitted for binary/unavailable). OPT-IN: capture "
            "must be turned on "
