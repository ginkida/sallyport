...
TOOLS: list[Tool] = [
    ...
    Tool(
        ...
        description=(
            ...
            "running tool call. Returns {connected, mode, version, port, "
            "pendingCalls, uptimeS, lastCalls, lastError, lastHandshakeError, "
            "lastHandshakeErrorAt}. mode is 'broker' (a shared broker daemon "
            ...
            "'it just timed out' to a specific tool/code. When connected=false, "
